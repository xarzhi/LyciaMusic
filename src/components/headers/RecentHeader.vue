    ...
    <div v-else class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-6 text-base font-medium pb-1">
        <button 
          ...
          :class="recentTab === 'songs' ? 'text-gray-900 dark:text-white font-bold text-xl relative after:content-[\'\'] after:absolute after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:w-4 after:h-1 after:bg-[#EC4141] after:rounded-full' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300'"
        >
          单曲
        </button>
        <button 
          @click="recentTab='playlists'" 
          :class="recentTab === 'playlists' ? 'text-gray-900 dark:text-white font-bold text-xl relative after:content-[\'\'] after:absolute after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:w-4 after:h-1 after:bg-[#EC4141] after:rounded-full' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300'"
        >
          歌单
        </button>
        <button 
          @click="recentTab='albums'" 
          :class="recentTab === 'albums' ? 'text-gray-900 dark:text-white font-bold text-xl relative after:content-[\'\'] after:absolute after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:w-4 after:h-1 after:bg-[#EC4141] after:rounded-full' : 'text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300'"
        >
          专辑
        </button>
      </div>
