...
<template>
  <div class="px-8 shrink-0 select-none flex flex-col pt-6 pb-0 h-auto justify-start border-b border-gray-100 dark:border-white/5 relative z-10 w-full bg-transparent">
    ...
    <div v-else class="flex gap-6 h-auto mt-2 mb-6">
      <!-- 封面图 (圆形) -->
      <div class="w-48 h-48 rounded-full shadow-sm flex items-center justify-center shrink-0 overflow-hidden group relative select-none bg-gray-200 dark:bg-white/10 border-4 border-white/50 dark:border-white/5">
        <div class="text-6xl text-gray-400 dark:text-gray-500 drop-shadow-sm">👤</div>
      </div>
      
      <!-- 文本信息与操作 -->
      <div class="h-48 flex flex-col justify-start pt-2 pb-1 flex-1 min-w-0">
        <!-- 歌手名字 -->
        <div class="mb-4">
